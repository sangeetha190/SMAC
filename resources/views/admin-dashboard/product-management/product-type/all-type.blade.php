...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Product Type</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Product Type</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('product-type.create') }}" style="margin-bottom: 10px"
                                class="btn btn-success btn-sm waves-effect waves-light"><i class="fa fa-plus"></i>
                                Create Type</a>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Product Type Details</h3>
                                </div>
                                            ...
                                            @if (!empty($allCategory))
                                                @foreach ($allCategory as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('product-type.edit', $value->id) }}"
                                                                ...
                                                                <div class="modal-dialog" style="width:55%">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form
                                                                                action="{{ route('product-type.destroy', $value->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="button"
