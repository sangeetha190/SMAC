...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Alignment</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Alignment</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                    <li class="active">Product Management</li>
                                    <li class="active">All Alignment</li>
                                </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('alignment.create') }}" style="margin-bottom: 10px"
                                class="btn btn-success btn-sm waves-effect waves-light"><i class="fa fa-plus"></i>
                                Create Alignment</a>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Product Alignment Details</h3>
                                </div>
                                            ...
                                            @if (!empty($allCategory))
                                                @foreach ($allCategory as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('alignment.edit', $value->id) }}"
                                                                ...
                                                                <div class="modal-dialog" style="width:55%">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form
                                                                                action="{{ route('alignment.destroy', $value->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="button"
