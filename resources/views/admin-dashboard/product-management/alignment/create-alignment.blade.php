...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Create Alignment</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Create Alignment</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                    <li><a href="#">Product Mangement</a></li>
                                    <li class="active">Create Alignment</li>
                                </ol>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Create Alignment Form</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="m-t-20">
                                                <form action="{{ route('alignment.store') }}" method="POST">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label>Alignment Name <span class="text-danger">*</span></label>
                                                        <input type="text" name="name" class="form-control" required placeholder="Product alignment name" />
                                                        @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        <div>
                                                            ...
                                                            <a href="{{ route('alignment.index') }}" class="btn btn-dark waves-effect m-l-5">
                                                                Cancel
                                                            </a>
                                                        </div>
                                                    </div>
