...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Create Product Tag</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Create Product Tag</h4>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Create Product Tag Form</h3>
                                </div>
                                                ...
                                                <form action="{{ route('product-tag.store') }}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control"
                                                            required placeholder="Product tag name" />
                                                        @error('name')
