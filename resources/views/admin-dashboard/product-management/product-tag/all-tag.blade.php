...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Product Tag</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('product-tag.create') }}" style="margin-bottom: 10px"
                                class="btn btn-success btn-sm waves-effect waves-light"><i class="fa fa-plus"></i>
                                Create Tag</a>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Product tag deatails</h3>
                                </div>
                                            ...
                                            @if (!empty($allCategory))
                                                @foreach ($allCategory as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('product-tag.edit', $value->id) }}"
                                                                ...
                                                                <div class="modal-dialog" style="width:55%">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form
                                                                                action="{{ route('product-tag.destroy', $value->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="button"
