...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Create Product</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Create Product</h4>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Create Product Form</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                            ...
                                            <div class="m-t-20">
                                                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="product_name" class="form-control" required placeholder="Type product name" />
                                                        @error('name')
                                        ...
                                        <div class="form-group">
                                            <label>Single Image <span class="text-danger">*</span></label>
                                            <input type="file" name="single_image" id="imageUpload" class="form-control" placeholder="Type something" required />
                                            <img id="imagePreview" src="#" alt="Image Preview" style="display: none; width: 200px; height: 200px;">
                                        </div>
                                        <div class="form-group">
                                            <label>Multiple Image </label>
                                            <input type="file" name="multiple_image[]" id="multiple_image" multiple class="form-control" placeholder="Type something" />
                                            <div id="imagePreviewContainer"></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Price <span class="text-danger">*</span></label>
                                            <input type="text" name="price" class="form-control" required placeholder="Type product price" />
                                            @error('price')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="stock" class="form-control" required placeholder="Type product stock" />
                                            @error('stock')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <label>Offer </label>
                                            <input type="number" name="offer" class="form-control" placeholder="Type product offer" />
                                            @error('offer')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <textarea required class="form-control" name="short_description" required rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Description <span class="text-danger">*</span></label>
                                            <div>
                                                <textarea required id="summernote" class="form-control" name="description" required rows="5"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <div class="checkbox checkbox-success">
                                                    <input id="checkbox{{ $value->id }}" type="checkbox" name="Alignment[]" value="{{ $value->id }}">
