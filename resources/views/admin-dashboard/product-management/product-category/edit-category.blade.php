...
<head>
    <meta charset="utf-8" />
    <title>Daati Devine - Edit Product Category</title>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Product Category Form</h3>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <select class="form-control" required name="status">
                                                                ...
                                                                <option value="1"
                                                                            @selected($productCategory->status == 1)>Active</option>
                                                                        <option value="0"
                                                                            @selected($productCategory->status == 0)>Inactive.
                                                                        </option>
                                                            </select>
                                                        </div>
                                                    </div>
