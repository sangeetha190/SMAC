...
<head>
    <meta charset="utf-8" />
    <title>Daati Divine - Customer</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            {{-- <a href="{{ route('users.create') }}" style="margin-bottom: 10px" class="btn btn-success btn-sm waves-effect waves-light"><i class="fa fa-plus"></i>
                                Create User</a> --}}
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Customer deatails</h3>
                                </div>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    @foreach ($value->getRoleNames() as $key => $rolename)
                                                    {{ $rolename }}
                                                    @endforeach
                                                </td> --}}
                                                <td>
                                                    <a href="{{ route('edit.customer', $value->id) }}" class="btn btn-info btn-xs waves-effect waves-light"><i class="fa fa-edit"></i></a>
