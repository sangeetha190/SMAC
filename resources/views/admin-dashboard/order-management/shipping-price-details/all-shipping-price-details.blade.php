...
<head>
    <meta charset="utf-8" />
    <title>SDM Admin - Shipping-Price-Details</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Shipping</h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Shipping Price Details</h3>
                                </div>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody>
                                            ...
                                            @if (!empty($allShipping))
                                                @foreach ($allShipping as $key => $value)
                                                    <tr>
                                                        <td>{{ $si_no++ }}</td>
                                                        <td>{{ $value->name }}</td>
                                                        <td>{{ $value->price }}</td>
                                                                ...
                                                                <div class="modal-dialog" style="width:55%">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form
                                                                                action="{{ route('shipping-price-details.destroy', $value->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="button"
