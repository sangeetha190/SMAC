...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image" data-bg="{{ asset('assets/user/img/bg/5.jpg') }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        {{-- <form id="search-form">
            ...
            <div class="hidden-div card w-100 " style="background: white;">
                <div class="search-results" aria-labelledby="dropdownMenuButton">
                </div>
            </div>
        ...
        {{-- <div class="header-search-2 mr-50">
            <form id="#123" method="get" action="#">
                ...
                <!-- <input type="text" name="search" value="" placeholder="Search here..." class="position:relative;"/> -->
