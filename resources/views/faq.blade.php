...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 08:44:57 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>SMAC - FAQ</title>
                                    ...
                                    <div id="faq-item-2-2" class="collapse show" data-parent="#accordion_2">
                                        <div class="card-body">
                                            <div class="ltn__video-img alignleft">
                                                <img src="{{ asset('assets/user/img/bg/17.jpg') }}"
                    ...
                    <div class="col-lg-4">
                        <aside class="sidebar-area ltn__right-sidebar">
                            ...
                            <div class="widget ltn__banner-widget">
                                <a href="{{route('shop')}}"><img src="{{ asset('assets/user/img/banner/banner-3.jpg') }}"
                                        alt="Banner Image"></a>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href=""><img src="{{ asset('assets/user/img/blog/1.jpg') }}"
                                        alt="#"></a>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href=""><img src="{{ asset('assets/user/img/blog/2.jpg') }}"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href=""><img src="{{ asset('assets/user/img/blog/3.jpg') }}"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href=""><img src="{{ asset('assets/user/img/blog/4.jpg') }}"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                                ...
                                <h3 class="ltn__blog-title"><a href="blog-details.html">He for your First Track
                                        Day!</a></h3>
                                <div class="ltn__blog-meta-btn">
                                    <div class="ltn__blog-meta">
                                        <ul>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href=""><img src="{{ asset('assets/user/img/blog/5.jpg') }}"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 08:44:58 GMT -->
